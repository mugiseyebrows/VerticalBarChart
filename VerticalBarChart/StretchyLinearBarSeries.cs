...
namespace VerticalBarChart
{
    ...
    /// </summary>
    public class StretchyLinearBarSeries : DataPointSeries
    {
        /// <summary>
        ...
        public BarSeriesItems Items { get; private set; }

        public class BarSeriesItems
        {
            public StretchyLinearBarSeries Series { get; set; }

            public void Add(BarItem item)
            {
                Series.Points.Add(new DataPoint(Series.Points.Count, item.Value));
            }
        ...
        /// </summary>
        public StretchyLinearBarSeries()
        {
            ...
            this.Items = new BarSeriesItems { Series = this };
        }
        ...
        protected override void UpdateAxisMaxMin()
        {
            ...
            this.XAxis.Include(0 - 0.5);
            this.XAxis.Include(Points.Count - 0.5);
        ...
        {
            return BarWidth * this.XAxis.Scale;
        }
